...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO events (name, description, event_date, location, max_capacity, created_by) VALUES (?, ?, ?, ?, ?, ?)");

    $stmt->bind_param("ssssii", $name, $description, $event_date, $location, $max_capacity, $created_by);
